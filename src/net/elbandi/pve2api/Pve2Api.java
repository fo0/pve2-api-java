...
public class Pve2Api {
	...
	public Volume getVolumeById(String node, String storage, String id)
			throws JSONException, LoginException, IOException {
	...
	public void updateStorage(net.elbandi.pve2api.data.Storage storage)
			throws LoginException, JSONException, IOException {
	...
	public void assignDiskToQemu(int vmid, String node, BlockDevice blockDevice)
			throws JSONException, LoginException, IOException, VmQemu.MissingFieldException {
	...
	public void resizeQemuDisk(int vmid, String node, QemuDiskUpdate diskUpdate)
			throws JSONException, LoginException, IOException {
	...
	/*
	 * public void getQemuConfig(String node, int vmid, VmQemu vm) throws
	 * JSONException, LoginException, IOException { JSONObject jObj =
	 * pve_action("/nodes/" + node + "/qemu/" + vmid + "/config",
	 * RestClient.RequestMethod.GET, null);
	...
	public String stopQemu(String node, int vmid, boolean keepActive)
			throws LoginException, JSONException, IOException {
	...
	public String createQemu(VmQemu vm)
			throws LoginException, JSONException, IOException, VmQemu.DeviceException, VmQemu.MissingFieldException {

		Map<String, String> params = vm.toMap(); // adding this to make it throw MissingFieldException right now in case
	...
	public void updateQemu(VmQemu vm)
			throws LoginException, JSONException, IOException, VmQemu.DeviceException, VmQemu.MissingFieldException {
	...
	/**
	 * @param nodeName
	 *            the name of the node the VM runs on.
	 * @param vmId
	 *            the id of the vm to update
	 * @param update
	 *            the update data
	 * @param async
	 *            true if request should return immediately, false if it should wait
	 *            for finished update.
	 *
	 ...
	 * @throws IOException
	 */
	public void updateQemu(String nodeName, int vmId, VmQemuUpdate update, boolean async)
			throws JSONException, LoginException, IOException {
	...
	public String shutdownQemu(String node, int vmid, int timeout, boolean keepActive, boolean forceStop)
		...
		return shutdownQemu(node, vmid,
				new PveParams("timeout", timeout).add("keepActive", keepActive).add("forceStop", forceStop));
	}
	...
	public String rollbackQemu(String node, int vmid, String snapname)
			throws LoginException, JSONException, IOException {
	...
	public String migrateOpenvz(String node, int vmid, String target)
			throws LoginException, JSONException, IOException {
